                        ...
                        <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                            <div class="bg-gray-900 rounded">
                                ...
                                <div class="modal-body px-8 py-8">
                                    <div class="responsive-container overflow-hidde relative" style="padding-top: 56.25%">
                                        <iframe src="https://youtube.com/watch?v={{ $movie['videos']['results'][0]['key'] }} height="315" width="560" style="border: 0" class="responsive-iframe absolute top-0 left-0 w-full h-full" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
